...
const SERVER_INFO = { name: "weather-hazards", version: "0.1.7" };
const TIMEOUT_MS = 25_000;
const UA = "WeatherHazardsPlugin/0.1.7 (contact: chucktastictime@gmail.com)";
const NWS_UA = UA;
/** CloudFront on metoc.navy.mil often 403s the generic plugin UA — JTWC fetches use a browser-like UA. */
const JTWC_UA =
  "Mozilla/5.0 (compatible; WeatherHazardsPlugin/0.1.7; +https://github.com/TheAbsentTourist/weather-web)";
